...
================================
-run_HRVEvaluationTool.sh (shell script for temporarily setting environment variables and 
                           executing the application)
   -to run the shell script, type
   
       ./run_HRVEvaluationTool.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v911, run the shell script as:
       ...
       ./run_HRVEvaluationTool.sh /mathworks/home/application/v911
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_HRVEvaluationTool.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure HRVEvaluationTool.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r HRVEvaluationTool.zip HRVEvaluationTool.app
    or the tar command 
    tar -cvf HRVEvaluationTool.tar HRVEvaluationTool.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/v911/runtime/maci64:MR/v911/sys/os/maci64:MR/v911/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_HRVEvaluationTool.sh 
